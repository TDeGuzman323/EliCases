...
bamboo11.addEventListener('click', () => {
    img.src = "../Images/productCase/iPhone/iPhone11/bamboo_iPhone11.png";
})

cherry11.addEventListener('click', () => {
    img.src = "../Images/productCase/iPhone/iPhone11/cherry_iPhone11.png";
})

rosewood11.addEventListener('click', () => {
    img.src = "../Images/productCase/iPhone/iPhone11/rosewood_iPhone11.png";
})
